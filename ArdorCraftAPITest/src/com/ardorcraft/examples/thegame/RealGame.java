...
public class RealGame implements ArdorCraftGame {
    ...
    private double origine = 0;
    
    private int blockType = 1;
    private float globalLight = 0f;//je vais modifier dessus: c'est normalement en 1f
    private boolean nuit = true;
...
while(vrai){
    ...
    while (indice>=0) {
        ...
        System.out.print(indice);
        globalLight = (float) Math.min(globalLight - tpf * 2, 1);
...
*/
    ...
    public void update(final ReadOnlyTimer timer) {
        ...
        /*
        if(timer.getTimeInSeconds() - origine > 5){
            ...
            origine = timer.getTimeInSeconds();
           }
        */
        if(timer.getTimeInSeconds() - origine > 5){
        	
            if(globalLight>= 0 && globalLight < 0.3f && nuit==true){
           	 globalLight = 0.3f;
            ...
            else if(globalLight>=0.3f  && globalLight <0.5f && nuit==false ){
            ...
            else if(globalLight>=0.5f && globalLight <0.7f && nuit==false ){
              	 globalLight = 0.7f;
             	for(int i=0;i<12;i++){
                   	blockWorld.setBlock(50, i, 42, 0);
               		blockWorld.setBlock(50, i, 58, 0);
               		blockWorld.setBlock(42, i, 50, 0);
               		blockWorld.setBlock(58, i, 50,0);}
              	 blockWorld.setGlobalLight(globalLight);
              	 updateLighting();
              	 origine = timer.getTimeInSeconds();
                 
               }
            else if(globalLight>=0.7f && globalLight <0.9f && nuit==false ){
             	 globalLight = 0.9f;
            ...
            else if(globalLight>=0.9f &&  nuit==false){
             	 globalLight = 0.7f;
            ...
            else if(globalLight<=0.9f && globalLight >0.7f && nuit==true){
           	 globalLight = 0.7f;
            ...
            else if(globalLight<=0.7f && globalLight >0.5f && nuit==true){
            	 globalLight = 0.5f;
            ...
            else if(globalLight<=0.5f && globalLight >0.3f && nuit==true){
           	 globalLight = 0.3f;
           	for(int i=0;i<12;i++){
               	blockWorld.setBlock(50, i, 42, 57);
           		blockWorld.setBlock(50, i, 58, 57);
           		blockWorld.setBlock(42, i, 50, 57);
           		blockWorld.setBlock(58, i, 50,57);}
           	
           	blockWorld.setBlock(51, 1, 51, 10);
           	blockWorld.setBlock(51, 2, 51, 10);
           	blockWorld.setBlock(51, 3, 51, 10);
           	blockWorld.setBlock(51, 4, 51, 86);
            ...
            else if(globalLight<=0.3f && globalLight >0.1f && nuit==true){
           	 globalLight = 0.1f;
           	 blockWorld.setGlobalLight(globalLight);
           	 updateLighting();
           	 origine = timer.getTimeInSeconds();
...
//            else if(globalLight<=0.5f && globalLight >0.3f ){
//           	 globalLight = 0.3f;
//           	 blockWorld.setGlobalLight(globalLight);
//           	 updateLighting();
//           	 origine = timer.getTimeInSeconds();
//              
//            }
//            else if(globalLight<=0.3f && globalLight >0.1f ){
//           	 globalLight = 0.1f;
//           	 blockWorld.setGlobalLight(globalLight);
//           	 updateLighting();
//           	 origine = timer.getTimeInSeconds();
...
//        if(timer.getTimeInSeconds() - origine > 15){
//        	
//            if(globalLight> 0.4f){
//           	 globalLight = 0;
//           	 blockWorld.setGlobalLight(globalLight);
...
//                    if(timer.getTimeInSeconds() > 25 )
//                    {
//                		globalLight = globalLight + 0.8f;
//                        blockWorld.setGlobalLight(globalLight);
//                        updateLighting();
//                    }
            	
            	
            	//if(((timer.getTimeInSeconds())-1)%30 == 0 ) jour = false;
            ...
            //if(jour = false){
            	//origine = timer.getTimeInSeconds();
            	//if(timer.getTimeInSeconds() == (origine + 6)) globalLight = globalLight + 1/5;	
            	//if(((timer.getTimeInSeconds())-1)%60 == 0 ) jour = true;
                //blockWorld.setGlobalLight(globalLight);
                //updateLighting();
    ...
    private void updateLighting() {
        ...
        while (indice>=0) {
            ...
            public void perform(final Canvas source, final TwoInputStates inputState, final double tpf) {
                globalLight = (float) Math.max(globalLight - tpf * 2, 0);//normalement c'est 0.4 ici
                blockWorld.setGlobalLight(globalLight);
                updateLighting();
            }
            globalLight = (float) Math.min(globalLight + tpf * 2, 1);
